...
export function TrackManagement() {
    ...
    return (
        <div className="grid gap-6 lg:grid-cols-[1.2fr,2fr]">
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className="bg-background/50 border-primary/10 transition-all focus:border-primary/30"
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="bg-background/50 text-foreground border-primary/10 min-h-24 w-full rounded-md border p-3 text-sm transition-all focus:border-primary/30 outline-none"
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="rounded-xl border border-dashed border-primary/10 p-3 space-y-3">
                            <div className="flex flex-wrap gap-2">
                                {selectedUsers.length === 0 ? (
                                    ...
                                    selectedUsers.map((user) => (
                                        <span key={user.uid} className="inline-flex items-center gap-2 rounded-full border border-primary/10 bg-primary/5 px-2.5 py-1 text-[10px] font-bold text-foreground">
                                            {user.name}
            ...
            {/* List Card */}
            <Card className="border-primary/10 bg-card/20 backdrop-blur-sm">
